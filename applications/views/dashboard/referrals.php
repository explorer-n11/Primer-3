            ...
            <form action="/dashboard/referrals" method="post">
                <div class="control-group form-group">
                    <div class="controls">
                        ...
                        <input type="text" class="form-control" name="link" value="<?php echo $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST']; ?>/account/register/<?php echo $_SESSION['authorize']['login']; ?>" readonly>
                ...
                <div class="control-group form-group">
                    <div class="controls">
                        ...
                        <input type="text" class="form-control" name="amount" value="<?php echo $_SESSION['authorize']['refBalance']; ?> $" readonly>
                        <p class="help-block"></p>
                    </div>
                </div>
